const SECTIONS = [
  {
    ...
    content: (
      <div className="space-y-3">
        <p className="font-medium text-stone-700 dark:text-stone-200">Information You Enter</p>
        <p>Make Today Doable may store information you voluntarily enter into the app, such as:</p>
        <ul className="space-y-1 pl-4 list-disc text-stone-500 dark:text-stone-400">
          <li>Daily tasks</li>
          <li>Routines</li>
  ...
  return (
    <div className="flex flex-col gap-6 p-4 sm:p-6 lg:p-8 max-w-2xl mx-auto w-full">
      ...
      <header className="space-y-1 pt-2">
        <p className="text-stone-400 dark:text-stone-500 text-sm">🔒 Your data stays yours</p>
